      ...
      >
        ...
        <div className="w-full lg:w-[55%] p-8 md:p-16 flex flex-col justify-center bg-[#0d1117]">
          <div className="max-w-[400px] w-full mx-auto">
            ...
            {/* OAuth buttons */}
            <div className="space-y-3 mb-8 animate-fade-in-up delay-100">
              <button
                type="button"
                className="w-full h-[46px] rounded-xl border border-white/[0.08] bg-white/[0.02] flex items-center justify-center gap-3 text-white hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-200 text-sm font-medium"
              >
            ...
            <div className="relative mb-8 animate-fade-in-up delay-200">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-[0.2em]">
                <span className="bg-[#0d1117] px-4 text-slate-500 font-semibold">
